-- begin CLINIC_OWNER
create unique index IDX_CLINIC_OWNER_UK_EMAIL on CLINIC_OWNER (EMAIL) where DELETE_TS is null ^
create unique index IDX_CLINIC_OWNER_UK_PHONE_NUMBER on CLINIC_OWNER (PHONE_NUMBER) where DELETE_TS is null ^
-- end CLINIC_OWNER
